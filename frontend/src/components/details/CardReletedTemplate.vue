      ...
      >
        <v-hover v-slot="{ isHovering, props }" class="card">
          <v-card
            ...
            v-bind="props"
            class="card bg-grey-lighten-2 ml-5 hover"
            :color="isSelected ? 'red' : 'grey-lighten-1'"
            @click="toggle"
          >
            ...
            <v-card-actions>
              <v-btn color="white" class="btn mt-10 bg-red mb-5 d-flex" @click.prevent="booking(event.id)"> 
                Booking
              </v-btn>
            </v-card-actions>
          </v-card>
